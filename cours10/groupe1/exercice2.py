def recherche_produits_par_prix(liste, prix_max):
    produits = []
    for element in liste :
        if element["prix"] <= prix_max:
            produits.append(element["nom_produit"])
...
produits_abordables = recherche_produits_par_prix(panier, 3)
print("Produits abordables:", produits_abordables)
